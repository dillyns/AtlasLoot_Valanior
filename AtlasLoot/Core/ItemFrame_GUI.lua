...
function AtlasLoot:CreateItemFrame()
	...
	Frame.Mythic = CreateFrame("CheckButton", "AtlasLootItemsFrame_Mythic", Frame, "OptionsCheckButtonTemplate")
	Frame.Mythic:SetPoint("TOPLEFT", Frame.Heroic, "BOTTOMLEFT", 0, 5)
	Frame.Mythic:SetWidth(25)
	Frame.Mythic:SetHeight(25)
	_G[Frame.Mythic:GetName().."Text"]:SetText(AL["Mythic"])
	Frame.Mythic:SetScript("OnShow", function(self)
		self:SetFrameLevel( (self:GetParent()):GetFrameLevel() + 1 )
	end)
	Frame.Mythic:SetScript("OnClick", AtlasLoot.MythicModeToggle)
	Frame.Mythic:Hide()
